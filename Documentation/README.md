...
The way of working is an hivemind where there is an central controller but the workers control also themself.
The workers will execute jobs based on their capacity.
